...
lista = [
  ...
  "Jacqueline de los ngeles Picado Azofeifa",
  "Jordan Sandoval Gonzalez",
  "Joseph Murillo Rodrguez",
  "Lidia Arce Picado",
  "Mara Roxana Chinchilla Vsquez",
  "Marcela de los ngeles Brenes Daniels",
...
discos = {
  ...
  "Cynthia Johanna Salazar Rodrguez  " => "Stand Up (1969)",
  "Elian Roberto Rojas Rojas  " => "Benefit (1970)",
  "Erick Ramos Mora  " => "Aqualung (1971)",
  "Erick Rojas Arias  " => "Thick as a Brick (1972)",
  "Fabián Conejo Segura  " => "A Passion Play (1973)",
  "Flor de Azalea Marcia Acua  " => "War Child (1974)",
  "Gabriela Sols Chavarra  " => "Minstrel in the Gallery (1975)",
  "Henry Artavia Chavarria  " => "Too Old to Rock 'n' Roll: Too Young to Die! (1976)",
  "Jacqueline de los ngeles Picado Azofeifa  " => "Songs from the Wood (1977)",
  ...
  "Marcela de los ngeles Brenes Daniels  " => "Under Wraps (1984)",
  "Maria Alejandra Serrano Ramrez  " => "Crest of a Knave (1987)",
  "Mauricio Badilla Blen  " => "Rock Island (1989)",
  "Oscar Vega Venegas  " => "Catfish Rising (1991)",
